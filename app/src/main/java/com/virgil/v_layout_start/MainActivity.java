package com.virgil.v_layout_start;
...
public class MainActivity extends AppCompatActivity implements MyItemClickListener {
    ...
    MyAdapter Adapter_linearLayout, Adapter_GridLayout, Adapter_FixLayout, Adapter_ScrollFixLayout, Adapter_FloatLayout, Adapter_ColumnLayout, Adapter_SingleLayout, Adapter_onePlusNLayout,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayoutHelper.setPadding(12, 12, 12, 12);// 设置LayoutHelper的子元素相对LayoutHelper边缘的距离
        //linearLayoutHelper.setMargin(20, 20, 20, 20);// 设置LayoutHelper边缘相对父控件（即RecyclerView）的距离。如果不设置则表示LayoutHelper充满父控件
        ...
        Adapter_linearLayout = new MyAdapter(this, linearLayoutHelper, 10, listItem) {
        ...
        stickyLayoutHelper.setOffset(0);// 设置吸边位置的偏移量（固定时距离顶部或者底部的距离）
...
//        }
        ...
        scrollFixLayoutHelper.setX(12);// 设置基准位置的横向偏移量X
        scrollFixLayoutHelper.setY(12);// 设置基准位置的纵向偏移量Y
...
//        }
        ...
        fixLayoutHelper.setX(12);// 设置基准位置的横向偏移量X
        fixLayoutHelper.setY(12);// 设置基准位置的纵向偏移量Y
