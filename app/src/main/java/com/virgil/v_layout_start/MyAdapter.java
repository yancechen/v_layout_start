 ...
 * Context：
 * Created by chenyouyu on 2017/5/2 10:48.
 */
...
public class MyAdapter extends DelegateAdapter.Adapter<MyAdapter.MainViewHolder> {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MainViewHolder(LayoutInflater.from(context).inflate(R.layout.item_rv_main, parent, false));
    }
    ...
    class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        public MainViewHolder(View root) {
            ...
            // 绑定视图
            Text = (TextView) root.findViewById(R.id.tv_item_main);
            image = (ImageView) root.findViewById(R.id.im_item_main);
